...
\input{capitulos/1_introduction.tex} 
%\input{capitulos/2_bibliographic_review.tex}
%\input{capitulos/3_Metodoogia.tex}
%\input{capitulos/4_Etapas_trabalho.tex}
%\input{capitulos/5_Cronograma.tex}
