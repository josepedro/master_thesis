...
\titulo{Ferramenta Computacional para Análise da Acústica Interna de Dutos com Diferentes Condições de Contorno}
\subtitulo{} % Opcional
...
\input{capitulos/lattice_boltzmann.tex}
\input{capitulos/palabos.tex}
\input{capitulos/modelos_numericos.tex}
\input{capitulos/validacoes.tex}
