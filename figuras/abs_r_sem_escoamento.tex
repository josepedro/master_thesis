\begin{tikzpicture}
 ...
 \addplot[color=black, mark=square, only marks] table[x index=0,y index=1] {dados/duto_sem_escoamento/analise_convergencia_10_abs_r.txt};
 \addplot[color=black, mark=triangle, only marks] table[x index=0,y index=1] {dados/duto_sem_escoamento/analise_convergencia_15_abs_r.txt};
 \addplot[color=black, mark=x, only marks] table[x index=0,y index=1] {dados/duto_sem_escoamento/analise_convergencia_5_abs_r.txt};
